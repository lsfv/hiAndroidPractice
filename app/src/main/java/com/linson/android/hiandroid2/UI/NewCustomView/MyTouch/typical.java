...
public class typical extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mInner.setOnTouchListener(new OutTouchListener());
        mOuter.setOnTouchListener(new OutTouchListener());
    }
    ...
    public static class OutTouchListener implements View.OnTouchListener
    {
